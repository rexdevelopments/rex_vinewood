...
Citizen.CreateThread(function()
    LoadFramework()
    TriggerServerEvent('rex_1:loadText')
end)

RegisterNetEvent('rex_1:openNui')
AddEventHandler('rex_1:openNui', function(text, color)
    nuiOpen = true
...
RegisterNUICallback('saveText', function(data)
    TriggerServerEvent('rex_1:saveText', data)
end)
...
RegisterNetEvent('rex_1:saveText')

...
LoadFramework = function()
    ...
    print('[rex-VinewoodSign] Framework found: ' .. FrameworkFound)
end
...
RegisterCommand(Config.Command, function(source, args, rawCommand)
    ...
    TriggerClientEvent('rex_1:openNui', source, GetFileData()[1], GetFileData()[2])
end)

RegisterServerEvent('rex_1:saveText')
AddEventHandler('rex_1:saveText', function(data)
    ...
    TriggerClientEvent('rex_1:saveText', -1, file)
end)

RegisterServerEvent('rex_1:loadText')
AddEventHandler('rex_1:loadText', function()
    TriggerClientEvent('rex_1:saveText', source, GetFileData())
end)
